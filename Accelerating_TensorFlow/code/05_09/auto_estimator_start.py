...
tf.app.flags.DEFINE_string('train_file',
                           '../images/mnist_train.tfrecords', 'Training File')
tf.app.flags.DEFINE_string('test_file',
                           '../images/mnist_test.tfrecords', 'Testing File')

tf.app.flags.DEFINE_string('out_dir',
                           'dnn_output', 'Output directory')

tf.app.flags.DEFINE_integer('train_steps', 8000, 'Number of training steps')
tf.app.flags.DEFINE_integer('batch_size', 80, 'Number of images in each batch')
tf.app.flags.DEFINE_integer('test_steps', 100, 'Number of test to perform')
